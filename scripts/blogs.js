var soccerBlog = [
  ...
  },
	{
		...
		summery: "Today I am going to try to explain Elliptic curve cryptography(ECC). ECC keeps messages and data private by transforming with multiplication based on a public key. When the information is needed again the message is divided by a private key to reveal the message. What keeps ECC secure is the math. Factoring is much more complex then multiplication. Math proofs and significant academic research has identified ECC as practically impossible to crack using existing technology."
	}
]
